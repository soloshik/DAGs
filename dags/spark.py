...
cmd = """
/opt/spark/work-dir/bin/spark-submit --master k8s://https://aksdns-ff976585.hcp.westeurope.azmk8s.io:443 --deploy-mode cluster --name spark-pi --class org.apache.spark.examples.SparkPi --conf spark.executor.instances=3 --conf spark.kubernetes.authenticate.driver.serviceAccountName=spark --conf spark.kubernetes.container.image=soloshik/spark:v2 local:///opt/spark/work-dir/SparkPi-assembly-0.1.0-SNAPSHOT.jar 
"""
