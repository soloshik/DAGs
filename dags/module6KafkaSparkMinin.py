...
stage_1 = KubernetesPodOperator(
    ...
    namespace='default',
    image='soloshik/pyspsrk:2.64',
    cmds=['/opt/spark/bin/spark-submit'],
    arguments=[
        '--master=k8s://https://aksdns-22dc58c5.hcp.westeurope.azmk8s.io:443',
        '--deploy-mode=cluster',
        '--name=spark-kafka',
        ...
        '--conf',
        'spark.kubernetes.container.image=soloshik/pyspsrk:2.64.2.37',
        '--conf',
...
stage_2 = KubernetesPodOperator(
    ...
    arguments=[
        ...
        '--packages=org.elasticsearch:elasticsearch-hadoop:7.12.1',
        '--conf',
        'spark.kubernetes.container.image=soloshik/pyspsrk:2.64',
        '--conf',
        'spark.kubernetes.authenticate.driver.serviceAccountName=spark',
         '--conf',
        'spark.jars.ivy=/tmp',
