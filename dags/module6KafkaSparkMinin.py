...
stage_1 = KubernetesPodOperator(
    ...
    namespace='default',
    image='soloshik/pyspsrk:2.60',
    cmds=['/opt/spark/bin/spark-submit'],
    arguments=[
        '--master=k8s://https://aksdns-5cb80069.hcp.westeurope.azmk8s.io:443',
        '--deploy-mode=cluster',
        '--name=spark-kafka',
        ...
        '--packages=org.elasticsearch:elasticsearch-spark-20_2.12:7.12.1',
        '--conf',
        'spark.kubernetes.container.image=soloshik/pyspsrk:2.60',
        '--conf',
